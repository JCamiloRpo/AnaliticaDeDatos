# -*- coding: utf-8 -*-
"""Ejercicio Cai - RN.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1u3UB-q8Jw9OxtVJPkQdvc4HeHloBzg3m
...
#Cargamos los datos
data = pd.read_excel("cai.xlsx", sheet_name="cai")
data.head()
...
model = MLPClassifier(activation = "identity", hidden_layer_sizes = (1,1,1), 
                     learning_rate = "adaptive", learning_rate_init = 0.01,
                     momentum = 0.09, max_iter = 400, verbose = True, random_state = 1)
...
#Cargamos los datos futuros
data_fut = pd.read_excel("cai.xlsx", sheet_name = "futuro")
data_fut.head()
